...
import { Description1, Description2, Description3, Left2, Left3, Right2, Right3, Row, Title } from '../components/Typo';
  ...
  return (
    <FullPageLayout>
      ...
      <InnerCard>
        <Inner>
          ...
          <Description2>
            ...
            <Row>
              <Left2>준비물</Left2>
              <Right2>1만원 내외의 랜덤 선물, 함께 즐길 술</Right2>
            </Row>
          </Description2>
        </Inner>
      </InnerCard>
      ...
      <Description3>
        ...
        <Right3>
          각자 어떤 선물인지 모르는 채로 나눠갖게 됩니다. 랜덤 선물 교환이죠! 때문에 포장 or 봉투에 담아 어떤 선물인지
          모르게 해주세요
        </Right3>
